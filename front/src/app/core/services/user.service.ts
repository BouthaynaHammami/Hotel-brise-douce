...
export class UserService {
  ...
  updateUserProfile(userId: number, profileData: UserProfileUpdate): Observable<UtilisateurResponse> {
    return this.http.put<UtilisateurResponse>(`${this.apiUrl}/users/${userId}/profile`, profileData);
  }
